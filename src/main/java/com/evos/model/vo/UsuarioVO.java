...
public class UsuarioVO {
    ...
    public UsuarioVO(long id, String nome, CargoVO cargo, Calendar dataAdmissao, String cpf, String dataNascimento, String email, boolean ativo, String dtaInc, String loginInc, String dtaAlt, String loginAlt) {
        this.id = id;
        this.nome = nome;
        this.cargo = cargo;
