...
public class ProdutoVO {
    ...
    public ProdutoVO(long id, String nome, TipoProduto tipo, CategoriaVO categoria, Calendar dataCadastro, boolean ativo, String dtaInc, String loginInc, String dtaAlt, String loginAlt) {
        this.id = id;
        this.nome = nome;
        this.tipo = tipo;
